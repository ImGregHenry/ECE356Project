	...
	private void initialize() {
		...
		btn_Update.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				if(pageLoadMode == PatientLoadMode.UPDATE)
				{
					dbQuery.Patient_UpdatePatientInformation(txt_PatientID.getText(), txt_SIN.getText(), txt_FirstName.getText(), 
							txt_LastName.getText(), txt_HealthCardNum.getText(), txt_Address.getText(), txt_PhoneNumber.getText());
					
					lbl_UpdateMessage.setText("Patient Update Successful.");
				}
				else if(pageLoadMode == PatientLoadMode.CREATE)
				{
					dbQuery.Patient_CreateNewPatientInformation(txt_SIN.getText(), txt_FirstName.getText(), 
							txt_LastName.getText(), txt_HealthCardNum.getText(), txt_Address.getText(), txt_PhoneNumber.getText());
